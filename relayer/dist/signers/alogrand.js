...
function decodeOnAlgo(input) {
    ...
    const receiver = algosdk_1.default.encodeAddress(algosdk_1.default.bigIntToBytes(BigInt(`0x${receiverHex}`), 32));
    return { assetId, amount, receiver };
}
exports.decodeOnAlgo = decodeOnAlgo;
