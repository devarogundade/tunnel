...
import type {
  VerifierUser,
  VerifierUserInterface,
} from "../../../contracts/_testContracts/VerifierUser";
...
type VerifierUserConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: VerifierUserConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class VerifierUser__factory extends ContractFactory {
  constructor(...args: VerifierUserConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): Promise<VerifierUser> {
    return super.deploy(overrides || {}) as Promise<VerifierUser>;
  }
  ...
  override attach(address: string): VerifierUser {
    return super.attach(address) as VerifierUser;
  }
  override connect(signer: Signer): VerifierUser__factory {
    return super.connect(signer) as VerifierUser__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): VerifierUserInterface {
    return new utils.Interface(_abi) as VerifierUserInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): VerifierUser {
    return new Contract(address, _abi, signerOrProvider) as VerifierUser;
  }
}
